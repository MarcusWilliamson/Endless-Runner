class Tutorial extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(game.config.width / 2, game.config.height / 2 + game.config.height / 4, 'Press ESC to return', menuConfig).setOrigin(0.5);
        ...
        this.add.text(game.config.width / 2, game.config.height - game.config.height / 15, credits, menuConfig).setOrigin(0.5);
